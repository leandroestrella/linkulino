...
- 🗄️ backup giornalieri dell'intero foglio, esportati in XLSX e salvati su cPanel fuori dalla web root — la rotazione mantiene gli ultimi 14 giornalieri più 6 mensili (opzionale, configurazione self-hosted)
