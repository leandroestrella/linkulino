...
- 📊 una dashboard mensile più una pagina di riepilogo completa — totali e medie mensili/annuali per periodo, vacanze combinate, per persona, e spese comuni vs. individuali, con un tooltip al passaggio del mouse su ogni valore calcolato che ne spiega il calcolo
