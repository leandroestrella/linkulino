...
- 📊 un panel mensual más una página de resumen completa — totales y medias mensuales/anuales por periodo, vacaciones combinadas, por persona, y gastos comunes vs. individuales, con un tooltip al pasar el ratón sobre cada valor calculado que explica cómo se obtiene
